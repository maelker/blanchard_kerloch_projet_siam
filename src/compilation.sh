...
CFLAGS="-g -Wall -Wextra -Wno-unused-paramete"r

rm -f ../bin/*.o ../bin/jeu_siam

gcc -c api_siam.c $CFLASG
...
gcc api_siam.o condition_victoire_partie.o victoire_siam.o coordonnees_plateau.o coup_jeu.o entree_sortie.o jeu_siam.o joueur.o main.o mode_interactif.o orientation_deplacement.o parseur_mode_interactif.o piece_siam.o plateau_modification.o plateau_siam.o type_piece.o fonction_test.o poussee.o -o ../bin/jeu_siam
