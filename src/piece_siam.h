 ...
 *    Garantie:
 *      - Un retour
 valant 1 si la piece est un elephant ou un rhinoceros.
 *      - Un retour valant 0 sinon.
 */
 ...
 * *************************
 *    Assigne le nom 'rocher' et l'orientation 'aucune_orientation
 *      à une piece.
 *
 *    Necessite:
 *      - Un pointeur non NULL vers une piece_siam modifiable.
 *    Garantie:
 *      - Une piece mise a jour avec le type 'rocher' et l'orientation
 *      'aucune_orientation'.
 *      - Une piece mise a jour est un rocher.
 *      - La piece doit etre integre.
 */
 ...
 * *************************
 *    Assigne le nom 'case_vide' et l'orientation 'aucune_orientation
 *      à une piece.
 *
 *    Necessite:
 *      - Un pointeur non NULL vers une piece_siam modifiable.
 *    Garantie:
 *      - Une piece mise a jour avec le type 'case_vide' et 
 *      l'orientation 'aucune_orientation'.
...
/**
 * Fonction piece_afficher_nom_cours:
 * *************************
 *    Affiche de maniere lisible sur la console le type et l'orientation
 *      d'une piece (pour un animal) par une chaine de caractere courte.
 *
 *    Necessite:
 *      - Un pointeur non NULL vers une piece_siam non modifiable.
 *    Garantie:
 ...
 * *************************
 *    Cree une piece en fonction de son nom_cours.
 *
 *    Necessite:
 *      - Un nom cours de 3 caracteres.
 *    Garantie:
 *      - Une piece associé au nom cours donné. 
 *      - Affichage sur la console de la mention 'Erreur fonction' si 
 *      les caracteres ne sont pas dans es normes.
 */
